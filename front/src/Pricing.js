...
<div className="p-8 flex-1">
  <div href="#" className={`text-${fromColor ? fromColor : "green-500"} block text-lg text-2xl leading-tight font-medium mb-2`}>Starter</div>
  <div className="text-6xl text-black font-bold">$5.99<span className="text-lg text-gray-400">/per month</span></div>
  <p className="mt-4 text-lg">
  ...
  <div className="divide-y divide-dashed divide-gray-300 mt-4">
	  ...
	  <div className="py-2 flex  items-center">
		  <MenuAlt1Icon className={`w-6 h-6 mr-2 text-${fromColor ? fromColor : "green-500"}`} /> 
		  <div><span className="font-medium text-black">5,000</span>{` x `}Words</div>
	  </div>
	  {/* <div className="py-2 flex  items-center">
		  <PencilIcon className={`w-6 h-6 mr-2 text-${fromColor ? fromColor : "green-500"}`} /> 
	  ...
	  <div className="py-2 flex  items-center">
		  ...
		  <div><span className="font-medium text-black">Email support</span></div>
	  </div>
	  {/* <div className="py-2 flex  items-center">
...
<div className="p-8 flex-1">
  ...
  <div className="text-6xl text-black font-bold">$14.99<span className="text-lg text-gray-400">/per month</span></div>
  <p className="mt-4 text-lg">
		Elevate your business and optimize your workflow with the help of ThinkSpace AI
  </p>
  <div className="divide-y divide-dashed divide-gray-300 mt-4">
  <div className="py-2 flex  items-center">
		  <DatabaseIcon className={`w-6 h-6 mr-2 text-${fromColor ? fromColor : "green-500"}`} /> 
	  ...
	  <div className="py-2 flex  items-center">
		  <MenuAlt1Icon className={`w-6 h-6 mr-2 text-${fromColor ? fromColor : "green-500"}`} /> 
		  <div><span className="font-medium text-black">25,000</span>{` x `}Words</div>
	  </div>
	  {/* <div className="py-2 flex  items-center">
		  <PencilIcon className={`w-6 h-6 mr-2 text-${fromColor ? fromColor : "green-500"}`} /> 
	  ...
	  <div className="py-2 flex  items-center">
		  <UserIcon className={`w-6 h-6 mr-2 text-${fromColor ? fromColor : "green-500"}`} /> 
		  <div><span className="font-medium text-black">Priority email support</span></div>
	  </div>
	  {/* <div className="py-2 flex  items-center">
		  <CheckCircleIcon className={`w-6 h-6 mr-2 text-${fromColor ? fromColor : "green-500"}`} /> 
